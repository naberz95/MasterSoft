        ...
        <div class="col-md-6">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-flag"></i> Información del País</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('paises.store') }}" method="POST">
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Información:</strong> Este país se utilizará para clasificar las ciudades del sistema.
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Crear País
                            </button>
                        </div>
                    </form>
                </div>
